...
export const getServerSideProps: GetServerSideProps<{
  ...
  console.log("getServerSideProps for /swap");
  ...
  console.log(`Found ${swaps.length} open swaps`);
  ...
  try {
    ...
    // Serialize Date objects to strings for Next.js
    return {
      props: {
        openSwaps: JSON.parse(JSON.stringify(swapData)),
      },
    };
  } catch (e) {
