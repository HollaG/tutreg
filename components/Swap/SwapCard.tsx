...
import { Badge, Button, Center, Divider, Flex, HStack, Link, SimpleGrid, Stack, Tag, useColorModeValue, Text } from "@chakra-ui/react";
import { cleanArrayString, encodeLessonTypeToShorthand, formatTimeElapsed } from "../../lib/functions";
...
const SwapCard: React.FC<{
    ...
    requestSwap: (swapId: number, user: TelegramUser | null, type: "request" | "remove") => any,
